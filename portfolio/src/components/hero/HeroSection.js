    ...
    <div className="hero container">
      <div className="hero-text">
        <h1>
          ...
          bile App, Design & Development Agency
        </h1>
        <p>
          we create experiences for optimal user value and ROI, <br />
          our expertise lies in crafting B2B/B2C, progressive, 
          single-page <br /> and other Web & Mobile apps.
        </p>
